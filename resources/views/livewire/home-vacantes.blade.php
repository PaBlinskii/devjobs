            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-300">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        {{-- Con Flex-1 tomamos todo el espacio para que no se anche el botón --}}
                        <div class="md:flex-1">
                            <a class="text-2xl font-extrabold text-gray-600" href="{{ route('vacantes.show', $vacante->id ) }}">
                                {{$vacante->titulo}}
                            </a>
                        ...
                        <div class="mt-5 md:mt-0">
                            {{-- con el display block y text-center hacemos que el botón se anche en moviles --}}
                            <a 
